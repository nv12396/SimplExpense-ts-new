    ...
    <div className="flex flex-col w-full">
      ...
      <div className="w-full hidden md:flex mx-auto relative bg-primaryGreen mt-40 md:mt-72 flex-col items-center justify-center">
        ...
        <div className="text-center md:mt-32 py-24">
          ...
          <div className="flex md:flex-row flex-col justify-between md:px-24 px-8 gap-x-12 mt-12">
            <div>
              <h4 className="text-xl font-bold mb-6">
                Simplest way to track expenses
              </h4>
              <p className="text-lg max-w-md text-black md:text-center">
            ...
            <div>
              <h4 className="text-xl font-bold mb-6 mt-8 md:mt-0">
