...
export const TransactionTableFilter = ({
  ...
  return (
    <div className="flex items-center justify-center md:mt-2 mt-[22vh]">
      <div className="min-w-full w-full flex flex-col md:mt-8">
        ...
        >
          {!filteredTransactions?.length && !isLoading && (
            <div className="flex flex-col justify-center items-center ml-2 md:ml-32">
              <p className="text-xl md:mt-20 mb-8 text-gray-500">
